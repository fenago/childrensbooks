@echo off
echo Running Git Push Script for Childrens Stories
echo ==========================================

echo Setting remote repository to https://github.com/fenago/childrensbooks...
git remote remove origin 2>nul
git remote add origin https://github.com/fenago/childrensbooks.git
...
if /i "%confirm%"=="Y" (
  echo Pushing to GitHub repository: https://github.com/fenago/childrensbooks
